...
┗━━━━━━━━⬣`.trim(),
    ...
    // await conn.send3ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'Recoded By DanishGanz', '👤 Pemilik Bot', '.owner', '💵 Donasi', '.donasi', '📜 Rules', '.infobot', m)
    await conn.send3ButtonLoc(m.chat, await (await fetch(`https://i.ibb.co/rf2SN9X/20210930-143538.jpg`)).buffer(), text.trim(), 'Recoded By DanishGanz', '👤 Pemilik Bot', '.owner', '💵 Donasi', '.donasi', '📜 Rules', '.infobot', m)
